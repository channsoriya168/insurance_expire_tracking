export const INSURANCE_FIELDS = [
    { key: 'insurance_company', label: 'Insurance Company', type: 'text', required: false, section: 'General Information', placeholder: 'e.g. Forte Insurance' },
    { key: 'policy_no', label: 'Policy Number', type: 'text', required: false, section: 'General Information', placeholder: 'e.g. POL-2026-0001' },
    { key: 'policy_type', label: 'Policy Type', type: 'text', required: false, section: 'General Information', placeholder: 'e.g. Motor, Health, Property' },
    { key: 'insured_name', label: 'Insured Name', type: 'text', required: false, section: 'General Information', placeholder: 'Full name of the insured' },

    { key: 'contact_method', label: 'Contact Method', type: 'select', required: false, section: 'Contact Information' },
    { key: 'contact_value', label: 'Contact Details', type: 'text', required: false, section: 'Contact Information', placeholder: 'Phone number, email, or username' },
    ...
    { key: 'sum_insured', label: 'Sum Insured', type: 'number', required: false, section: 'Financial Details', placeholder: '0.00' },
    ...
    { key: 'expiry_date', label: 'Expiry Date', type: 'date', required: false, section: 'Dates & Status' },
